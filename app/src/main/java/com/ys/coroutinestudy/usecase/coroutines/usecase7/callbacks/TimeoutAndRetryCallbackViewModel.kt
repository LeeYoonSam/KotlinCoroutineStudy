...
class TimeoutAndRetryCallbackViewModel(
	...
	private var oreoFeaturesCall = mockApi.getAndroidVersionFeatures(27)
	private var pieFeaturesCall = mockApi.getAndroidVersionFeatures(28)
	...
	fun postErrorOrRetryGetPieFeatures() {
